...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'plugin.manager.config_inspector' => 'getPlugin_Manager_ConfigInspectorService',
            ...
            'restui.authentication_collector' => 'getRestui_AuthenticationCollectorService',
    ...
    public function getPlugin_CacheClearerService($lazyLoad = true)
    {
        ...
        $instance->addCachedDiscovery($this->get('plugin.manager.config_inspector'));
    ...
    /**
     * Gets the 'plugin.manager.config_inspector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\config_inspector\ConfigInspectorManager A Drupal\config_inspector\ConfigInspectorManager instance.
     */
    protected function getPlugin_Manager_ConfigInspectorService()
    {
        $this->services['plugin.manager.config_inspector'] = $instance = new \Drupal\config_inspector\ConfigInspectorManager($this->get('config.factory'), $this->get('config.typed'));

        $instance->_serviceId = 'plugin.manager.config_inspector';
    ...
    {
        $this->services['rest.link_manager.relation'] = $instance = new \Drupal\rest\LinkManager\RelationLinkManager($this->get('cache.default'), $this->get('entity.manager'), $this->get('unrouted_url_assembler'));
    ...
    {
        $this->services['rest.link_manager.type'] = $instance = new \Drupal\rest\LinkManager\TypeLinkManager($this->get('cache.default'), $this->get('unrouted_url_assembler'));
    ...
    /**
     * Gets the 'restui.authentication_collector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\restui\RestUIAuthenticationCollector A Drupal\restui\RestUIAuthenticationCollector instance.
     */
    protected function getRestui_AuthenticationCollectorService()
    {
        $this->services['restui.authentication_collector'] = $instance = new \Drupal\restui\RestUIAuthenticationCollector();

        $instance->addProvider($this->get('basic_auth.authentication.basic_auth'), 'basic_auth', 100);
        $instance->addProvider($this->get('user.authentication.cookie'), 'cookie', 0);
        $instance->_serviceId = 'restui.authentication_collector';
    ...
    {
        $this->services['restui.manager'] = $instance = new \Drupal\restui\RestUIManager($this->get('entity.manager'));

        $instance->_serviceId = 'restui.manager';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'config_inspector' => array(
                    'type' => 'module',
                    'pathname' => 'modules/contrib/config_inspector/config_inspector.info.yml',
                    'filename' => 'config_inspector.module',
                ),
                'contextual' => array(
                    'type' => 'module',
                ...
                'ncd8_config_manager' => array(
                    'type' => 'module',
                    'pathname' => 'modules/custom/ncd8_config_manager/ncd8_config_manager.info.yml',
                    'filename' => NULL,
                ),
                'ncd8_config_rest' => array(
                    'type' => 'module',
                    'pathname' => 'modules/custom/ncd8_config_rest/ncd8_config_rest.info.yml',
                    'filename' => 'ncd8_config_rest.module',
                ),
                'node' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\config_inspector' => 'modules/contrib/config_inspector/src',
                ...
                'Drupal\\ncd8_config_manager' => 'modules/custom/ncd8_config_manager/src',
                'Drupal\\ncd8_config_rest' => 'modules/custom/ncd8_config_rest/src',
                ...
                'Drupal\\restui' => 'modules/contrib/restui/src',
                ...
                'Drupal\\minimal' => 'core/profiles/minimal/src',
